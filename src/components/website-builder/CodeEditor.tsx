...
const CodeEditor: React.FC<CodeEditorProps> = ({ html, css, js, onChange }) => {
  ...
  return (
    <div
      className="flex-1 flex flex-col bg-[#1e1e1e] text-white"
        ...
        <div className="h-full overflow-visible p-4">
          <div className="flex">
            ...
            <textarea
              ...
              spellCheck={false}
              className="flex-1 bg-transparent outline-none resize-none text-gray-300 leading-relaxed whitespace-pre"
              style={{
                tabSize: 2,
